...
python src/infer.py \
    --model outputs/finetune/back-translation-large-tablet-ft/fold0/best_model \
    --input-path data/generated_translation_like_english_10k_fold0/generated_translation_like_english.csv \
    --output-path data/generated_translation_like_english_10k_fold0/generated_translation_like_english_back_translated.csv \
